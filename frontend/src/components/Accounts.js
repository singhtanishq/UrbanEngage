...
const Accounts = () => {
    ...
    const handleLogin = () => {
        ...
        axios.post('${process.env.REACT_APP_BASE_URL}/accounts/login', { email, password })
            .then(response => {
    ...
    const handleSignUp = () => {
        ...
        axios.post('${process.env.REACT_APP_BASE_URL}/accounts/signup', { name, email, password })
            .then(() => {
                setIsLogin(true);
    ...
    const handleSave = () => {
        ...
        axios.post('${process.env.REACT_APP_BASE_URL}/accounts/update', updatedData)
            .then(response => {
